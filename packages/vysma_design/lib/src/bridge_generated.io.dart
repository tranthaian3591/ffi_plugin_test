...
class VysmaDesignPlatform extends FlutterRustBridgeBase<VysmaDesignWire> {
  VysmaDesignPlatform(ffi.DynamicLibrary dylib) : super(VysmaDesignWire(dylib));
...
class VysmaDesignWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  VysmaDesignWire(ffi.DynamicLibrary dynamicLibrary) : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  VysmaDesignWire.fromLookup(ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName) lookup) : _lookup = lookup;
